...
csv_file = "product_reviews_intel_processors.csv"
...
def main():
    ...
    user_question = st.text_input("Ask a Question (e.g., 'What is the review of Intel Core i5-12600K')", key="user_question")
